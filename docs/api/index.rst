...
- **video** : the module defines the 'image' and 'video' classes, which consists of a polarimetric image or video array and associated metadata. Methods of the class include plotting and saving routines.
